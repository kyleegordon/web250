        ...
        <main class="main">
            <div class="row text-center">
                <div class="col-sm-12 h2">
                    <h2 class="assignment-title">Sam's Used Cars</h2>
...
while ($result_ar = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>" . $result_ar['Model'] . "</td>";
       echo "<td>" . $result_ar['ASKING_PRICE'] . "</td>";
        echo "<td><a href='contents/joy_of_php/FormEdit.php?VIN=".$result_ar['VIN']."'>Edit</a>  <a href='contents/joy_of_php/deletecar.php?VIN=".$result_ar['VIN']."'>Delete</a></td>";
   echo "</tr>\n";
